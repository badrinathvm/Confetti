//
//  HipsterConfettiView.swift
//  Confetti
//
//  Created by Badrinath on 9/7/19.
...
public final class HipsterConfettiView: UIView {
    public init() {
    ...
    private final class Layer: CAEmitterLayer {
        ...
        override func layoutSublayers() {
            ...
            //emitterPosition.x - emitterSize.width/2, emitterPosition.y, emitterZPosition) to (emitterPosition.x + emitterSize.width/2, emitterPosition.y, emitterZPosition)
            emitterMode = .outline
            emitterShape = .line
            //emitterSize = CGSize(width: frame.size.width, height: 1.0)
            //emitterPosition = CGPoint(x: frame.size.width / 2.0, y: 0)
            emitterSize = CGSize(width: self.bounds.width, height: 1.0)
            emitterPosition = CGPoint(x: 10, y: 200)
        }
    }
}

// MARK: - CAAnimationDelegate
extension HipsterConfettiView: CAAnimationDelegate {
...
// MARK: -
fileprivate extension HipsterConfettiView.Content.Shape {
...
fileprivate extension HipsterConfettiView.Content {
    var color: UIColor? {
        switch self {
